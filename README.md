...
|---|---|---|---|---|---|---|
| `arm64` | `aarch64-linux-gnu` | LP64, hard-float | 7.1.4 | 16 (`releases/gcc-16`) | 2.47 | 2.43 |
| `arm` | `arm-linux-gnueabihf` | EABI hard-float, VFPv3-D16 | 7.1.4 | 16 (`releases/gcc-16`) | 2.47 | 2.43 |
